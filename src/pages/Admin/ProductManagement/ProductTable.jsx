...
const ProductTable = () => {
  return (
    <Container fluid>
      <Row className="header-row bg-secondary rounded-2 py-3 d-none d-md-flex">
        <Col className="sno">
          S.No.
        ...
        <Col className="action d-flex align-items-center justify-content-center">
          <Dropdown>
            ...
            <Dropdown.Menu>
              ...
              <Dropdown.Item>View Product</Dropdown.Item>
              <Dropdown.Item>Add Arrivals</Dropdown.Item>
              <Dropdown.Item>Add Best Selling</Dropdown.Item>
              <Dropdown.Item>Add Featured</Dropdown.Item>
              <Dropdown.Item>Add Trending</Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
        </Col>
      </Row>
      <Row className="responsive-data-row py-3 d-md-none  border rounded-3">
        <Row className="m-0">
          ...
          <Col>
            <Col className="product-name text-start fw-bold">Printed Shirt</Col>
            <Col className="price text-start">300 Rs</Col>
            <Col className="stock-status text-start fw-bold text-success">In Stock</Col>
          </Col>
        ...
        <Col className="quantity text-start col-4 mt-3">Quantity: <span className="fw-bold">20</span></Col>
        <Col className="created-at col-8 mt-3">Created At: <span className="fw-bold"> 05/05/2024</span></Col>
